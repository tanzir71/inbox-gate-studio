...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "InboxGate Neo-Studio" },
      { name: "description", content: "Advanced HTML email template and newsletter compiler with a premium dark workspace." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "InboxGate Neo-Studio" },
      { property: "og:description", content: "Advanced HTML email template and newsletter compiler with a premium dark workspace." },
